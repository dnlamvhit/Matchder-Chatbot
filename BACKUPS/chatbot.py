...
def initialize():
  if 'initialized' not in st.session_state:
    ...
    st.session_state.prompt_history = [{"role": "system", "content": ("You are Matchder marketing assistant. "
      "If users search for products, ask them if they can clarify ambigious inputs then confirm final query before calling search_product(). "
      "If you have not enough info to provide, refer them to Matchder website dev.matchder.com")}]
